...
var make_styles = (main_content, main_content_right, main_content_left, collisons, description) => {
...
export const drawTimeTable = async (pid, pyear, ndays = 5, type = 'Seminar') => {
    ...
    Data(pid, pyear).then(data => {
        ...
        if (data !== null | undefined) {
            ...
            make_styles(main_content, main_content_right, main_content_left);
            ...
            top_content.classList.add("swiper-wrapper")

            var wrap_top_content = document.createElement("div")
            wrap_top_content.classList.add("swiper")
            wrap_top_content.classList.add("topSwiper")
            wrap_top_content.appendChild(top_content);

            wrap_top_content.style = `
                
            `;

            top_content = wrap_top_content;
