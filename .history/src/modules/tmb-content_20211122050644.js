...
export const drawTimeTable = async (pid, pyear, ndays = 5, type = 'Seminar') => {
    ...
    Data(pid, pyear).then(data => {
        ...
        if (data !== null | undefined) {
            ...
            top_content.classList.add("swiper-pagination");
            ...
            for (let i = 0; i < ndays; i++) {
                ...
                title.innerHTML = `
                    ...
                    ">${days[i]}</label>
                    `;
                    title.classList.add("swiper-pagination-bullet")
            ...
            days_navigation.innerHTML = `
            <div class="swiper-scrollbar-drag" style="width: 153.2px; transform: translate3d(0px, 0px, 0px);"></div>
                `;
                days_navigation.classList.add("swiper-scrollbar")
            top_content.appendChild(days_navigation);
